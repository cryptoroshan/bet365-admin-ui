...
const ExcludeEventsTableItem = ({ item, onHandleDeleteClick }: ExcludeEventsTableItemProps) => {
  return (
    <tr className="text-white bg-[#777]">
      <td className="px-2 py-1 border border-gray-600">{item.event}</td>
      <td className="px-2 py-1 border border-gray-600">{item.agent}</td>
      <td className="px-2 py-1 border border-gray-600">{item.time}</td>
